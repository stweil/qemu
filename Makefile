...
.PHONY: all clean cscope dist distclean doc dvi html \
	info install install-doc install-tools msi \
	pdf txt recurse-all speed test tools FORCE
...
install: all $(if $(BUILD_DOCS),install-doc) $(if $(CONFIG_TOOLS),install-tools) \
