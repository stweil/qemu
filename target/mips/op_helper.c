...
QEMU_NORETURN void helper_raise_exception_debug(CPUMIPSState *env)
{
    do_raise_exception(env, EXCP_DEBUG, 0);
}

static QEMU_NORETURN
void raise_exception(CPUMIPSState *env, uint32_t exception)
{
...
void QEMU_NORETURN mips_cpu_do_unaligned_access(CPUState *cs, vaddr addr,
