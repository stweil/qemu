...
void G_NORETURN HELPER(wfe)(CPUARMState *env)
{
...
void G_NORETURN HELPER(yield)(CPUARMState *env)
{
    CPUState *cs = env_cpu(env);
 ...
 */
void G_NORETURN HELPER(exception_internal)(CPUARMState *env, uint32_t excp)
{
    CPUState *cs = env_cpu(env);
...
void G_NORETURN
HELPER(exception_with_syndrome_el)(CPUARMState *env, uint32_t excp,
                                   uint32_t syndrome, uint32_t target_el)
{
    raise_exception(env, excp, syndrome, target_el);
}
